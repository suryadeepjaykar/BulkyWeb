...
namespace BulkyBookWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult UpdateOrderDetail(int orderId)
        {
            ...
            TempData["success"] = "Order Datails Updated Successfully!";
        ...
        public IActionResult ShipOrder()
        {
            ...
            orderHeader.ShippinngDate = DateTime.Now;
        ...
        public IActionResult GetAll(string status)
        {
            ...
            switch (status) {
                case "pending":
                    objOrderHeaders = objOrderHeaders.Where(u => u.PaymentStatus == SD.PaymantStatusDelayedPayment);
                    break;
                case "inprocess":
